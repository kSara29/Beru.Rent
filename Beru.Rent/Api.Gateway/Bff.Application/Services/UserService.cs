        ...
        IOptions<RequestToUserApi> jsonOptions) : IUserService
{
    ...
    {
        // var httpConnection =
        //     await serviceHandler.HttpGetConnection
        //         (serviceHandler.CreateConnectionUrlWithQuery(jsonOptions.Value.Url, "Account/Login"));
        // var response = await serviceHandler.ResponseSuccess(httpConnection);
        return null;
    }
}